		...
		<view class="func-box">
			...
			<view class="func-item">
				<view class="inner-box" @click="openPage(2)">
					...
					<view class="func-remark">物质申请</view>
				</view>
			</view>
			<view class="func-item">
<!-- 				<view class="inner-box" @click="getStuInfo">
					<u-icon name="chat-fill" color="#ff0000" class="phone-icon" size="70"></u-icon>
					<view class="func-title">消息通知</view>
					<view class="func-remark">请假审批，反馈审批</view>
				</view> -->
			</view>
		</view>
		<TabBar></TabBar>
	...
	methods: {
		openPage(i) {
			switch (i) {
				case 0:
					uni.navigateTo({
						url: '/pages/epidemicPersonnel/index/openCard'
					});
					break;
				case 1:
					uni.navigateTo({
						url: '/pages/epidemicPersonnel/index/feedback'
					});
					break;
				case 2:
					uni.navigateTo({
						url: '/pages/epidemicPersonnel/index/myFeed/myFeed'
					});
					break;
				case 3:
					break;
