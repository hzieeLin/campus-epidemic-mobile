<template>
	<view class="page-container">
		<view class="top">
			...
			<view class="code">	<u-icon name="scan" size="50" @click="changeShowScan"></u-icon></view>
			<view class="more">
				<u-icon
					name="more-dot-fill"
					size="40"
		...
		<view class="btn-list" v-if="showTwoScan">
			<view class="my-calendar"><uni-calendar class="uni-calendar--hook" :showMonth="true" :selected="info.selected" @change="change" @monthSwitch="monthSwitch" /></view>
		</view>
...
import { QueryIsolationTime } from '@/api/isolation.js';
